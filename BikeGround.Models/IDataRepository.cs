...
namespace BikeGround.Models
{
    ...
    public interface IDataRepository<TEntity> where TEntity : new()
    {
        ...
        /// <param name="filters"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetWhereAsync(object filters, string filterOperator="AND");
        ...
        /// <param name="filters"></param>
        /// <returns></returns>
        Task<TEntity> GetFirstAsync(object filters, string filterOperator = "AND");
        ...
        /// <param name="instance"></param>
        /// <returns></returns>
        Task<long> InsertAsync(TEntity instance);
