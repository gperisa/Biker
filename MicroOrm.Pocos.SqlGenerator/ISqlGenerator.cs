...
namespace MicroOrm.Pocos.SqlGenerator
{
    ...
    public interface ISqlGenerator<TEntity> where TEntity : new()
    {
        ...
        /// </summary>
        /// <returns></returns>
        string GetSelectAllPaged(string sinceId, string count);
        ...
        /// <returns></returns>
        string GetSelect(object filters, string filterOperator="AND");
        ...
        /// <param name="filters"></param>
        /// <returns></returns>
        string GetSelectPaged(object filters, string sinceId, string count, string filterOperator = "AND");
